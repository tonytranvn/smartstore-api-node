 ...
 * @param {Object} opt
 */
function SmartStoreAPI(opt) {
  if (!(this instanceof SmartStoreAPI)) {
    return new SmartStoreAPI(opt);
  }
 ...
 * @param {Object} opt
 */
SmartStoreAPI.prototype._setDefaultsOptions = function(opt) {
  this.url             = opt.url;
 ...
 * @return {string}
 */
SmartStoreAPI.prototype._normalizeQueryString = function(url) {
 ...
 * @return {String}
 */
SmartStoreAPI.prototype._getUrl = function(endpoint) {
  var url = '/' === this.url.slice(-1) ? this.url : this.url + '/';
  var api = this.wpAPI ? this.wpAPIPrefix + '/' : 'api/';
  var ver = this.version ? this.version + '/' : '/';
 ...
 * @return {Object}
 */
SmartStoreAPI.prototype._getOAuth = function() {
  var data = {
    consumer: {
 ...
 * @return {Object}
 */
SmartStoreAPI.prototype._request = function(method, endpoint, data, callback) {
  ...
  var params = {
    ...
    headers: {
      'User-Agent': 'SmartStore API Client-Node.js/' + this.classVersion,
 ...
 * @return {Object}
 */
SmartStoreAPI.prototype.get = function(endpoint, callback) {
 ...
 * @return {Object}
 */
SmartStoreAPI.prototype.post = function(endpoint, data, callback) {
 ...
 * @return {Object}
 */
SmartStoreAPI.prototype.put = function(endpoint, data, callback) {
 ...
 * @return {Object}
 */
SmartStoreAPI.prototype.delete = function(endpoint, callback) {
 ...
 * @return {Object}
 */
SmartStoreAPI.prototype.options = function(endpoint, callback) {
 ...
 */
promise.promisifyAll(SmartStoreAPI.prototype);
